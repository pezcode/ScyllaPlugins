...
#define PLUGIN_NAME "TPP" //???

class ScyllaTPP : public ScyllaPlugin
{
public:
	virtual ~ScyllaTPP() { }
...
ULONG_PTR ScyllaTPP::resolveImport(ULONG_PTR ImportTableAddressPointer, ULONG_PTR InvalidApiAddress, ScyllaStatus& Status)
{
	//PECompact example
