...
#define PLUGIN_NAME "Expressor v1.5.x"

class ScyllaExpressor : public ScyllaPlugin
{
public:
	virtual ~ScyllaExpressor() { }

	virtual ULONG_PTR resolveImport(ULONG_PTR, ULONG_PTR, ScyllaStatus&);
};

ULONG_PTR ScyllaExpressor::resolveImport(ULONG_PTR ImportTableAddressPointer, ULONG_PTR InvalidApiAddress, ScyllaStatus& Status)
{
	//PECompact example
